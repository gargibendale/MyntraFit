...
import 'package:myntra/welcome.dart';
...
class _StoriesPageState extends State<StoriesPage> {
  ...
  Future<void> _fetchStories() async {
    try {
      print("Fetching reviews and chats...");
      final QuerySnapshot snapshot =
          await FirebaseFirestore.instance.collection('reports').get();
      print("Fetched ${snapshot.docs.length} chats.");
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to fetch chats: $e')),
      );
    }
  }
  ...
  Future<List<Comment>> _fetchComments(String storyId) async {
    ...
    try {
      ...
      print("Error fetching comments for chat $storyId: $e");
    }
    return comments;
  }
  ...
  void _addComment(String storyId, Comment comment) async {
    try {
      ...
      print("Error adding comment to chat $storyId: $e");
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            ); // Assuming you have a route named '/womenSafety'
          },
        ),
        actions: <Widget>[
          IconButton(
      ...
      backgroundColor: const Color.fromARGB(
          255, 255, 255, 255), // Moved this inside the Scaffold
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Comments:',
              style: TextStyle(
                  color: const Color.fromARGB(255, 129, 34, 0),
                  fontWeight: FontWeight.bold),
            ),
            SizedBox(height: 10),
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: Text(
                    ...
                    style:
                        TextStyle(color: const Color.fromARGB(255, 100, 17, 0)),
                  ),
                );
              },
            ),
