...
class DisplayKidsPage extends StatefulWidget {
  @override
  _DisplayKidsPageState createState() => _DisplayKidsPageState();
}

class _DisplayKidsPageState extends State<DisplayKidsPage> {
...
// Print header to check column names
      ...
      filteredData = dataRows
          .where((row) {
            ...
            return (row[genderIndex] == 'Girls' ||
                row[genderIndex] == 'Boys' &&
